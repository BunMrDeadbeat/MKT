                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" value="{{ old('description') }}" id="product-description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500"></textarea>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <label for="product-image-upload" class="cursor-pointer bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 px-4 rounded-lg inline-flex items-center">
                                        ...
                                        <input type="file" name="image" id="product-image-upload" class="hidden" accept="image/*">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="border border-dashed border-gray-300 rounded-lg p-4">
                                        ...
                                        <label for="product-gallery-upload" class="cursor-pointer bg-gray-100 hover:bg-gray-200 text-gray-800 py-1 px-3 rounded-lg inline-flex items-center text-sm">
                                            ...
                                            <input type="file" name="gallery[]" id="product-gallery-upload" class="hidden" accept="image/*" multiple>
                                        </label>
